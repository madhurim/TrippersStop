(function () {
    ...
    function DestinationController(
        ...
        $scope.aboutUsText = "Trippism is a unique and innovative solution to the problem of destination discovery in leisure travel. Around the world data and statistics show that leisure travelers want to go somewhere , however don't know where. Most online travel businesses offer good prices and booking mechanisms , however no means to figure out where you can go. Here is where Trippism comes. Our state of the art workflow suggests you destinations given your origin , dates , budget and preferences like themes , regions etc.. Each destination when picked gives you an overview of that destination which includes key decision making information like lowest current fares, fare intelligence , weather history , traffic seasonality , attractions , attraction related videos. Each destination opens in a new tab which allows easy navigation from one destination to another. It's all about the art of destination discovery , making it easier by bringing together relevant information based on historical data and user generated content across the web. We are not a travel booking engine nor do we intend to give you the best deal for that travel search. We provide the current lowest published fares by airlines combined with fare intelligence that enables you to understand the fare trends and see if the current fares are in your budget. Our success lies in you being able to discover that destination based on your preferences and our information.Team Trippism is made of dedicated , smart and passionate professionals who are striving everyday to put the best solution out there. Our business know how and technical strengths combined , enable us to bring this innovative travel offering. This is just a soft beta launch and there is much more to come , which will help you find your vacation destination of choice. ";
        $scope.aboutUs = function () {
            alertify.alert('About Us',$scope.aboutUsText);
        };
