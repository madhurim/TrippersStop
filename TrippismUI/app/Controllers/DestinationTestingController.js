...
(function () {
    'use strict';
    var controllerId = 'DestinationTestingController';
    angular.module('TrippismUIApp').controller(controllerId,
        ['$scope', '$location', '$modal', '$rootScope', '$timeout', 'DestinationFactory', 'UtilFactory', 'FareforecastFactory', 'SeasonalityFactory', DestinationTestingController]);

    function DestinationTestingController($scope, $location, $modal, $rootScope, $timeout, DestinationFactory, UtilFactory, FareforecastFactory, SeasonalityFactory) {
       ...
       // $scope.tabManager.select(0);
        ...
        $scope.ViewDestination = ViewDestination;
