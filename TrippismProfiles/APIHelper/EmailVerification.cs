...
namespace TrippismProfiles
{
    ...
    public class EmailVerification
    {
        ...
        public static void SendMail(string firstName, string pwd, string ToEmailID)
        {
            ...
            var result = Task.Run(() => MailgunEmail.SendComplexMessage("noreply@trippism.com", "Trippism: +", new List<string>() { ToEmailID }, body));
        }
        ...
        public static void SendUserMail(string from, string to, string subject, string htmlbody)
        {
            var result = Task.Run(() => MailgunEmail.SendComplexMessage(from, subject, new List<string>() { to }, htmlbody));
        }
    }
}