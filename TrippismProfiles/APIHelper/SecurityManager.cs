...
namespace TrippismProfiles
{
    ...
    public static class SecurityManager
    {
        ...
        /// <param name="authDetailsRepository">repository used to validate the password.</param>
        /// <returns>bool</returns>
        public static Tuple<bool, Guid> IsTokenValid(string token, string ip, string userAgent, IAuthDetailsRepository authDetailsRepository)
        {
            try
            {
                ...
                if (parts.Length == 3)
                {
                    ...
                    if (!expired && authDetailsRepository != null)
                    {

                        var authDetails = authDetailsRepository.FindCustomer(username);
                        ...
                        string password = authDetails.Password;
                            ...
                            {
                                return new Tuple<bool, Guid>(true, authDetails.Id);
