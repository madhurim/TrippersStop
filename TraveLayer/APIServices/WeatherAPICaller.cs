...
{
    public class WeatherAPICaller : IAsyncWeatherAPICaller
    {
        ...
        {           
            _ClientId = ConfigurationManager.AppSettings["WeatherClientkey"].ToString();
            _BaseAPIUri = new Uri(ConfigurationManager.AppSettings["WeatherBaseAPIUri"].ToString() + "api/" + _ClientId + "/");
        }
