...
namespace TrippismApi.Areas.Sabre.Controllers
{
    ...
    public class ThemeAirportController : ApiController
    {
        ...
        /// </summary>
        public ThemeAirportController(IAsyncSabreAPICaller apiCaller, ICacheService cacheService, ITokenManager tokenManager)
        {
        ...
        {
            _tokenManager.SetApiToken(_apiCaller, _cacheService);
            APIResponse result = _apiCaller.Get(url).Result;
            if (result.StatusCode == HttpStatusCode.Unauthorized)
            {
                _tokenManager.RefreshApiToken(_cacheService, _apiCaller);
